...
---
_Note: For the full interactive experience including dropdown data validations for Priority/Status and automated dynamic KPI counters, please refer to the master tracking `Javeats_Lite_Master_Requirements_Matrix.xlsx` sheet hosted inside this repository._
